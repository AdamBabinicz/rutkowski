...
export default function Timeline() {
  ...
  return (
    <div className="relative">
      {/* Timeline line */}
      <div className="absolute left-8 md:left-1/2 md:transform md:-translate-x-1/2 w-1 h-full bg-gradient-to-b from-watercolor-ochre-accent to-watercolor-umber-accent rounded-full"></div>
      ...
      <div className="space-y-8 sm:space-y-12">
        {events.map((event, index) => (
          ...
          >
            ...
            <div className="absolute left-8 md:relative md:left-0 md:w-2/12 md:flex md:justify-center w-auto flex justify-center mt-2">
              <div
