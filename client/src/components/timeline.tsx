  ...
  const events: TimelineEvent[] = [
    {
      ...
      description: "Ukończenie Państwowego Ogniska Plastycznego w Radomiu z dyplomem 'Za wybitne osiągnięcia'.",
    ...
    },
    {
      ...
      description: "Pierwsze wystawy indywidualne i udział w plenerach malarskich w Polsce.",
    ...
    },
    {
      ...
      description: "Rozwinięcie charakterystycznego stylu akwarelowego z naciskiem na pejzaże i naturę.",
    ...
    },
    {
      ...
      description: "Udział w wystawach międzynarodowych i uznanie za wkład w rozwój polskiej akwareli.",
    ...
    },
    {
      ...
      description: "Kontynuacja twórczości i przekazywanie doświadczenia młodszemu pokoleniu artystów.",
      color: "gradient",
      side: "left",
    },
  ];
